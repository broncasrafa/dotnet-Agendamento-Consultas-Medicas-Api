...
namespace RSF.AgendamentoConsultas.Infra.Identity.Migrations
{
    ...
    [Migration("20250122180606_Adicionando-Tabelas-do-Identity-2")]
    partial class AdicionandoTabelasdoIdentity2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSF.AgendamentoConsultas.Core.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RSF.AgendamentoConsultas.Core.Domain.Entities.ApplicationUser", null)
                        .WithMany()
