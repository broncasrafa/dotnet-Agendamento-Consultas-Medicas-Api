...
using RSF.AgendamentoConsultas.Application.Handlers.Features.Especialidade.GetAll;
using RSF.AgendamentoConsultas.Application.Handlers.Features.Especialidade.GetById;
using RSF.AgendamentoConsultas.Application.Handlers.Features.Especialidade.GetByName;
using RSF.AgendamentoConsultas.Application.Handlers.Features.Especialidade.Responses;
using RSF.AgendamentoConsultas.Application.Handlers.Features.EspecialidadeGrupo.GetAll;
using RSF.AgendamentoConsultas.Application.Handlers.Features.EspecialidadeGrupo.GetById;
...
internal static class EspecialidadesEndpoints
{
    ...
    {
        var routes = builder.MapGroup("api/especialidades").WithTags("Especialidades");
