...
using RSF.AgendamentoConsultas.Application.Features.TipoStatusConsulta.GetAll;
using RSF.AgendamentoConsultas.Application.Features.TipoStatusConsulta.GetById;
