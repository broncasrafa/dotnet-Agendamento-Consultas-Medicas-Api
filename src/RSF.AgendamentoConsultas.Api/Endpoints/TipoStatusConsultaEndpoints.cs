...
using RSF.AgendamentoConsultas.Application.Handlers.Features.TipoStatusConsulta.GetAll;
using RSF.AgendamentoConsultas.Application.Handlers.Features.TipoStatusConsulta.GetById;
...
internal static class TipoStatusConsultaEndpoints
{
    ...
    {
        var routes = builder.MapGroup("api/tipos/status-consulta").WithTags("Tipos de Status da Consulta");
