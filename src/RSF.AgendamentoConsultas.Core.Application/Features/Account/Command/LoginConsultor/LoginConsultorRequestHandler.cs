...
public class LoginConsultorRequestHandler : IRequestHandler<LoginConsultorRequest, Result<AuthenticatedUserResponse>>
{
    private readonly IAccountManagerService _accountManagerService;

    public LoginConsultorRequestHandler(IAccountManagerService accountManagerService) => _accountManagerService = accountManagerService;

    public async Task<Result<AuthenticatedUserResponse>> Handle(LoginConsultorRequest request, CancellationToken cancellationToken)
    {
