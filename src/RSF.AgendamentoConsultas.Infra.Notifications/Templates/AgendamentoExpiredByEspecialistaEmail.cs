...
public class AgendamentoExpiredByEspecialistaEmail : MailTemplateBase
{
    public AgendamentoExpiredByEspecialistaEmail(IMailSender mailSender, IAmazonS3 s3Client) 
    ...
    {
        var htmlBody = await GetHtmlTemplateFromS3Async(bucketName: "rsfrancisco.agendamentoconsultas.emailtemplates", key: "agendamento_canceled_by_especialista_template.html");
        htmlBody = htmlBody
