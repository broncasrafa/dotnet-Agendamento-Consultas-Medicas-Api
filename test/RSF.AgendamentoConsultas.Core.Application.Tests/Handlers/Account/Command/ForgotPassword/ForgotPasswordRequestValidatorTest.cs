...
public class ForgotPasswordRequestValidatorTest
{
    private readonly Faker _faker;
    private readonly ForgotPasswordRequestValidator _validator;

    public ForgotPasswordRequestValidatorTest()
    {
    ...
    {
        var request = new ForgotPasswordRequest(Email: _faker.Person.Email);
